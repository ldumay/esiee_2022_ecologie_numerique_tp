...
def calcul_scipy_temp(minutes: int, temperature_cable: float, temperature_ambiant: float, intensity: int,
                      wind_speed: float):
...
def calcul_temp_minutes(minutes: int, temperature_cable: float, temperature_ambiant: float, intensity: int,
                        wind_speed: float):
