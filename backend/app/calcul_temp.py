...
def calcul_scipy_temp(minutes: int, temperature_cable: float, temperature_ambiant: float, intensity: float, wind_speed: float):
...
def calcul_scipy(y, t, temperature_ambiant: float, intensity: float, wind_speed: float):
...
def calcul_temp_minutes(minutes: int, temperature_cable: float, temperature_ambiant: float, intensity: float, wind_speed: float):
...
def calcul_temp_minute(temperature_cable: float, temperature_ambiant: float, intensity: float, wind_speed: float):
...
def calcul_temp(temperature_cable: float, temperature_ambiant: float, intensity: float, wind_speed: float) -> float:
